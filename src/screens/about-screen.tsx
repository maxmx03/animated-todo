      ...
      >
        <VStack flex={1} space={4}>
          ...
          <LinkButton
            ...
            leftIcon={
              <Icon as={Feather} name="youtube" size="md" opacity={0.5} />
            }
          >
          ...
          <LinkButton
            ...
            leftIcon={
              <Icon as={Feather} name="twitter" size="md" opacity={0.5} />
            }
          >
            @inkdrop_app
          </LinkButton>
          ...
          <LinkButton
            ...
            leftIcon={
              <Icon as={Feather} name="external-link" size="md" opacity={0.5} />
            }
          >
